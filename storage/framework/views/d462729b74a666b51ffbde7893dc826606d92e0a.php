<?php $__env->startSection('title', 'Halaman Dashboard Admin'); ?>

<?php $__env->startSection('breadcrumb'); ?>
  <li><a href="<?php echo e(route('dashboard.admin')); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
  <li class="<?php echo e(set_active('dashboard.admin')); ?>">Dashboard</li>
...
<?php $__env->startSection('content'); ?>
  <div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-yellow">
        <div class="inner">
          <h3><?php echo e(count($Pumrohs)); ?></h3>
          <p>Pemesanan Umroh</p>
          <i>Baru</i>
        </div>
        <div class="icon">
    ...
    <div class="col-lg-6 col-xs-6">
      <div class="small-box bg-aqua">
        <div class="inner">
          <h3><?php echo e(count($Ptours1)); ?></h3>
    ...
    <div class="col-lg-6 col-xs-6">
      <div class="small-box bg-green">
        <div class="inner">
          <h3><?php echo e(count($Pumrohs1)); ?></h3>
