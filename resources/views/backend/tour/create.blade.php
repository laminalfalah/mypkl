...
@section('breadcrumb')
  ...
  @elseif (Auth::user()->hasRole('operator'))
    ...
    <li>Dashboard</li>
    <li class="{{ set_active('operator.tour.create') }}">Tambah Paket Tour</li>
  @else
    <li><a href="{{ route('dashboard.company') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li>Dashboard</li>
    <li class="{{ set_active('company.tour.create') }}">Tambah Paket Tour</li>
  @endif
@endsection
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          @if (Auth::user()->hasRole('admin'))
            ...
            {!! Form::close() !!}
          @elseif (Auth::user()->hasRole('operator'))
            {!! Form::open(['url' => route('operator.tour.store'), 'method' => 'post', 'class' => 'form-horizontal']) !!}
            <div class="form-group {{ $errors->has('name') ? 'has-error': ' '}}">
              <div class="form-group">
                {!! Form::label('title','NAMA PAKET', ['class' => 'col-md-2 control-label']) !!}
                <div class="col-md-9">
            ...
            {!! Form::close() !!}
          @else
            {!! Form::open(['url' => route('company.tour.store'), 'method' => 'post', 'class' => 'form-horizontal']) !!}
            <div class="form-group {{ $errors->has('name') ? 'has-error': ' '}}">
              <div class="form-group">
                {!! Form::label('title','NAMA PAKET', ['class' => 'col-md-2 control-label']) !!}
                <div class="col-md-9">
