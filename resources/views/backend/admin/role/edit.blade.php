...
@section('breadcrumb')
  ...
  <li>Dashboard</li>
  <li class="{{ set_active('role.edit') }}">Edit Role</li>
@endsection
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          {!! Form::model($role,['url' => route('role.update',$role->id), 'method' => 'post', 'class' => 'form-horizontal' ]) !!}
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
              <div class="form-group">
                {!! Form::label('name','Level', ['class' => 'col-md-2 control-label']) !!}
                <div class="col-md-9">
                  {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Nama Level', 'readonly']) !!}
